...
// Получить объекты только неактивных пользователей (поле isActive).
...
const getUniqueSkills = arrayOfSkills =>
  arrayOfSkills.reduce((uniqueSkills = [], skill) => {
    if (!uniqueSkills.includes(skill)) {
      uniqueSkills.push(skill);
    }
    return uniqueSkills.sort();
  }, []);
console.log(getUniqueSkills(skills));
